...
export default function EndOfModule() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-4xl font-bold mb-4">Congratulations! You've Completed Module 1</h2>
      <p className="text-xl max-w-2xl mx-auto mb-8">
        You've mastered the fundamentals of CX project management and are now ready to dive deeper into using the
        Support Readiness Tracker in Module 2.
      </p>

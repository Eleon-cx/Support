...
const questions = [
  {
    question: "Which feature of the Support Readiness Tracker helps in assigning responsibilities to team members?",
    options: ["Task Management", "Deadline Tracking", "Ownership Assignment", "Progress Monitoring"],
    correctAnswer: "Ownership Assignment",
  },
  {
    question: "What is a key benefit of using milestones in deadline management?",
    options: [
      "It makes the project look more complex",
      "It allows for more accurate time tracking",
      "It helps break the project into manageable chunks",
      "It increases the overall project duration",
    ],
    correctAnswer: "It helps break the project into manageable chunks",
  },
]
...
export default function MiniQuiz() {
  ...
  const handleSubmit = () => {
    ...
    if (correct) {
      markActivityCompleted("module2_miniQuiz")
    }
  }
  ...
  return (
    <section className="py-16 px-6 bg-gradient-to-br from-indigo-50 to-purple-100">
      <h2 className="text-4xl font-bold mb-10 text-center bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">
        Knowledge Check: Support Readiness Tracker
      </h2>
          ...
          {!submitted ? (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
              <p className="text-xl mb-4">
                {allCorrect
                  ? "Great job! You've mastered the key concepts of the Support Readiness Tracker."

...
export default function Welcome() {
  const scrollToLearningObjectives = () => {
    const learningObjectivesSection = document.getElementById("module4_learningObjectives")
  ...
  return (
    ...
    >
      <Image
        src="/placeholder.svg?height=600&width=1200&text=Measuring%20Success%20and%20Continuous%20Improvement"
        alt="Measuring Success and Continuous Improvement Background"
        layout="fill"
        objectFit="cover"
      ...
      <div className="relative z-10">
        ...
        >
          Optimizing Your CX Projects for Long-Term Success
        </motion.h2>
        <motion.p
        ...
        >
          Welcome to Module 4! Here, we&apos;ll explore how to measure the success of your CX projects and implement
          strategies for continuous improvement. Learn to set meaningful KPIs, create insightful reports, and foster a
          culture of ongoing enhancement in your CX operations.
        </motion.p>
        <motion.button

...
export default function EndOfModule() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-4xl font-bold mb-4">Congratulations! You've Completed Module 5</h2>
      <p className="text-xl max-w-2xl mx-auto mb-8">
        You've successfully managed a full project lifecycle in our End-to-End Simulation! You're now ready to learn
        about post-project review and continuous improvement in Module 6.
      </p>

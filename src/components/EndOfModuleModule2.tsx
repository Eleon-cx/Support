...
export default function EndOfModule() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-4xl font-bold mb-4">Congratulations! You've Completed Module 2</h2>
      <p className="text-xl max-w-2xl mx-auto mb-8">
        You've mastered the Support Readiness Tracker fundamentals and learned valuable skills in task organization,
        deadline management, and ownership assignment. You're now ready to explore advanced techniques in Module 3!
      </p>

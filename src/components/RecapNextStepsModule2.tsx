...
export default function RecapNextSteps() {
  const recapPoints = [
    "Mastered the Support Readiness Tracker fundamentals",
    "Learned effective task organization techniques",
    "Understood deadline management strategies",
    "Explored efficient ownership assignment methods",
  ]

  const router = useRouter()
  const { areActivitiesCompleted } = useActivities()

  const requiredActivities = ["module2_miniQuiz"]
  ...
  const handleNextModule = () => {
    if (canProceedToNextModule) {
      ...
      const element = document.getElementById("module2_miniQuiz")
      if (element) {
  ...
  return (
    <section className="py-16 px-6 bg-gradient-to-br from-indigo-50 to-blue-100">
      <h2 className="text-4xl font-bold mb-10 text-center text-indigo-700">Module 2 Recap & What's Next</h2>
        ...
        >
          ...
          <div className="bg-indigo-50 p-6 rounded-lg">
            ...
            <p className="text-gray-600 mb-4">
              In the next module, we'll explore advanced techniques for optimizing your support readiness process,
              including automation, integration with other tools, and data-driven decision making.
            </p>
            <motion.button

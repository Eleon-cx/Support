...
export default function EndOfModule() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-4xl font-bold mb-4">Congratulations! You've Completed Module 4</h2>
      <p className="text-xl max-w-2xl mx-auto mb-8">
        You've mastered task and timeline management! You're now ready to put your skills to the test in our End-to-End
        Simulation in Module 5.
      </p>

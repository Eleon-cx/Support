...
const questions = [
  {
    question: "Which of the following is NOT a common retrospective technique?",
    options: ["Start, Stop, Continue", "Sailboat Retrospective", "5 Whys", "Project Celebration Party"],
    correctAnswer: "Project Celebration Party",
  },
  {
    question: "What is the primary purpose of the '5 Whys' technique?",
    options: [
      "To identify five key project successes",
      "To dig deep and find the root cause of issues",
      "To create five new project goals",
      "To recognize the top five team members",
    ],
    correctAnswer: "To dig deep and find the root cause of issues",
  },
  {
    question: "Which section of a lessons learned document focuses on obstacles faced during the project?",
    options: ["Project Overview", "Successes", "Challenges", "Lessons Learned"],
...
export default function MiniQuiz() {
  ...
  const handleSubmit = () => {
    ...
    if (correct) {
      markActivityCompleted("module6_miniQuiz")
    }
  }
  ...
  return (
    <section className="py-16 px-6 bg-gradient-to-br from-purple-50 to-pink-100">
      <h2 className="text-4xl font-bold mb-10 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">
        Knowledge Check: Post-Project Review and Documentation
      </h2>
          ...
          {!submitted ? (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
              <p className="text-xl mb-4">
                {allCorrect
                  ? "Congratulations! You've mastered the concepts of post-project review and documentation."

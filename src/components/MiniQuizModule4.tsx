...
const questions = [
  {
    question: "Which of the following is NOT typically considered a key performance indicator (KPI) for CX projects?",
    options: [
      "Customer Satisfaction Score (CSAT)",
      "Net Promoter Score (NPS)",
      "First Response Time",
      "Number of employees in the CX team",
    ],
    correctAnswer: "Number of employees in the CX team",
  },
  {
    question: "What is the primary purpose of creating a KPI Dashboard?",
    options: [
      "To impress senior management",
      "To visually represent key performance indicators over time",
      "To keep CX team members busy",
      "To replace written reports entirely",
    ],
    correctAnswer: "To visually represent key performance indicators over time",
  },
  {
    question: "Which of the following is a best practice for creating effective CX reports?",
    options: [
      "Use as much technical jargon as possible",
      "Include every piece of data available",
      "Tailor the content and format to the audience's needs",
      "Always use the same template for all reports",
    ],
    correctAnswer: "Tailor the content and format to the audience's needs",
  },
]
...
export default function MiniQuiz() {
  ...
  const handleSubmit = () => {
    ...
    if (correct) {
      markActivityCompleted("module4_miniQuiz")
    }
  }
  ...
  return (
    <section className="py-16 px-6 bg-gradient-to-br from-purple-50 to-pink-100">
      <h2 className="text-4xl font-bold mb-10 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">
        Knowledge Check: Measuring Success and Reporting
      </h2>
          ...
          {!submitted ? (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
              <p className="text-xl mb-4">
                {allCorrect
                  ? "Congratulations! You've mastered the concepts of measuring success and creating effective CX reports."
